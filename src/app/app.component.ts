...
import { faCircleLeft, faCircleRight, faEnvelope, faTrashCan, faUser } from '@fortawesome/free-regular-svg-icons';
...
export class AppComponent implements OnInit {
  ...
  constructor(library: FaIconLibrary) {
    library.addIcons(faPhone, faEnvelope, faEllipsis, faLocationDot, faHouse, faUser, faGear, faTrashCan, faCircleInfo, faCircleLeft, faCircleRight);
  }
