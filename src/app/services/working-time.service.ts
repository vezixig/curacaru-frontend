...
export class WorkingTimeService {
  ...
  getWorkTimeList(year: number, month: number, page: number, pageSize: number = 20) {
    return this.httpClient.get<Page<WorkingHoursReportListEntry>>(`${this.apiUrl}/work-time/list`, {
      params: {
        year: year,
        month: month,
        page: page,
